unit StringDistance.OptimalStringAlignment;
...
{$REGION 'OptimalStringAlignment'}
  TOptimalStringAlignment = class(TInterfacedObject, IStringDistance)
  strict private
...
function TOptimalStringAlignment.Distance(const A, B: string): Integer;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if (I > 1) and (J > 1) and (A.Chars[I-1] = B.Chars[J-2]) and (A.Chars[I-2] = B.Chars[J-1]) then
        Matrix[I, J] := StringDistance.Minimum(Matrix[I, J], Matrix[I-2, J-2] + Cost);
    end;
  end;
